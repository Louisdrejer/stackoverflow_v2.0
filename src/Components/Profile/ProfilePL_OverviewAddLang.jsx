...
export default function ProfilePl_OverviewAddLang({ user, onDiscard }) {
        ...
        <div className="ProgrammingLanguages">
          ...
          <div className="PLdropdown">
            ...
            <div className="PLdropdown-content">
              <p onClick={() => handleLanguageChange('Python')} style={{cursor:"pointer"}}>Python</p>
              <p onClick={() => handleLanguageChange('Java')}  style={{cursor:"pointer"}}>Java</p>
              <p onClick={() => handleLanguageChange('JavaScript')}  style={{cursor:"pointer"}}>JavaScript</p>
            </div>
        ...
        <div className="SkillLevel">
          ...
          <div className="SkillLvldropdown">
            ...
            <div className="SkillLvldropdown-content">
              <p onClick={() => handleSkillLevelChange('Beginner')}  style={{cursor:"pointer"}}>Beginner</p>
              <p onClick={() => handleSkillLevelChange('Intermediate')}  style={{cursor:"pointer"}}>Intermediate</p>
              <p onClick={() => handleSkillLevelChange('Expert')}  style={{cursor:"pointer"}}>Expert</p>
            </div>
            <div className="Skillarrow-down"></div>
          </div>
          <button className='discardButton' onClick={handleDiscard}>x</button>
        </div>
      </div>
    </div>
  );
