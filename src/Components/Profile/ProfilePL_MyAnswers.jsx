...
export default function ProfilePL_MyAnswers() {
  return (
   <div className="myAnswersContainer">
    ...
    <div className="myAnswerBox">
          ...
          <div className="myAnswerUserQ">
            ...
            <div className="myAnswerusername">Username</div>
          </div>
        <div className="myAnswerBody">
          <div className="myAnswerBodyText">Body text</div>
        </div>
        <div className="myAnswerTags">
